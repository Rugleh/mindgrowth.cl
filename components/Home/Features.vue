...
<section>
  ...
  <div class="bg-light mr-md-3 pt-3 px-3 pt-md-4 px-md-4 text-center overflow-hidden features">
    <div class="my-3 py-3">
      ...
      <p class="lead">Te acompañamos, orientamos y planificamos el proceso de crecimiento de tu neogocio o PYME</p>

    </div>
    <img class="image-growth lazyload img-fluid" src="~/assets/images/svg/growth-orange.svg" alt="mindgrowth sube tus ventas">
  ...
  <div class="bg-light mr-md-3 pt-3 px-3 pt-md-4 px-md-4 text-center overflow-hidden features">
    ...
    <img class="image-money lazyload img-fluid" src="~/assets/images/svg/money-orange.svg" alt="mindgrowth sube tus ventas">
    <br>
    <br>
  </div>
  <div class="bg-light mr-md-3 pt-3 px-3 pt-md-4 px-md-4 text-center overflow-hidden features">
    ...
    <img class="image-success lazyload img-fluid" src="~/assets/images/svg/success-orange.svg" alt="mindgrowth sube tus ventas">
