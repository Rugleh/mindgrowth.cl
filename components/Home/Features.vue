...
<section>
  ...
  <div class="bg-light mr-md-3 pt-3 px-3 pt-md-4 px-md-4 text-center overflow-hidden features">
    ...
    <img class="image-growth img-fluid" src="~/assets/images/svg/growth-orange.svg" alt="mindgrowth sube tus ventas">
  ...
  <div class="bg-light mr-md-3 pt-3 px-3 pt-md-4 px-md-4 text-center overflow-hidden features">
    ...
    <img class="image-money img-fluid" src="~/assets/images/svg/money-orange.svg" alt="mindgrowth sube tus ventas">
    <br>
    <br>
  </div>
  <div class="bg-light mr-md-3 pt-3 px-3 pt-md-4 px-md-4 text-center overflow-hidden features">
    ...
    <img class="image-success img-fluid" src="~/assets/images/svg/success-orange.svg" alt="mindgrowth sube tus ventas">
